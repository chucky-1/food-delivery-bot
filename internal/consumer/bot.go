...
var (
	welcomeMessage = "🍽 Добро пожаловать в бот ресторана «Нефть»! 🍽\n\n" +
		"Мы рады приветствовать вас в нашем уютном ресторане, где вы можете насладиться вкусными обедами, не покидая уют своего офиса.\n\n" +
		"Что мы предлагаем:\n" +
		...
		"е забудьте посмотреть наше меню и сделать свой первый заказ. Мы уверены, что вы останетесь довольны!\n\n" +
